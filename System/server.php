 ...
 */
    ...
    class server_equiposPage extends DetailPage
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('DetailGridserver.equipos_id_partes_fru_partes_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridserver.equipos_id_partes_fru_partes_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridserver.equipos_id_partes_fru_partes_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridserver.equipos_id_partes_fru_partes_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridserver.equipos_id_partes_fru_partes_handler_compare');
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('id_partes', 'id_partes_fru_partes', 'Id Partes', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridserver.equipos_id_partes_fru_partes_handler_list', $column);
            ...
            $column = new TextViewColumn('id_partes', 'id_partes_fru_partes', 'Id Partes', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridserver.equipos_id_partes_fru_partes_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_partes', 'id_partes_fru_partes', 'Id Partes', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridserver.equipos_id_partes_fru_partes_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for fru_partes field
            //
            $column = new TextViewColumn('id_partes', 'id_partes_fru_partes', 'Id Partes', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridserver.equipos_id_partes_fru_partes_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class serverPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_server', 'id_server', $this->RenderText('Id Server')),
                new FilterColumn($this->dataset, 'serie', 'serie', $this->RenderText('Serie')),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            $main_editor = new TextEdit('id_server_edit');
            ...
            $main_editor = new TextEdit('serie_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserGrantForDataSource('server.equipos')->HasViewGrant() && $withDetails)
            {
            //
            // View column for server_equipos detail
            //
            $column = new DetailColumn(array('id_server'), 'server.equipos', 'server_equipos_handler', $this->dataset, 'Equipos');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            //
            // View column for id_server field
            //
            $column = new NumberViewColumn('id_server', 'id_server', 'Id Server', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_cliente_nombre_cliente_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_proyecto_descripcion_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_sitio_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new BlobImageViewColumn('fotografia_server', 'fotografia_server', 'Fotografia Server', $this->dataset, true, 'serverGrid_fotografia_server_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_cliente_nombre_cliente_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_proyecto_descripcion_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_sitio_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            
            //
            // View column for fotografia_server field
            //
            $column = new BlobImageViewColumn('fotografia_server', 'fotografia_server', 'Fotografia Server', $this->dataset, true, 'serverGrid_fotografia_server_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new FileUploadingColumn('Fotografia Server', 'fotografia_server', $editor, $this->dataset, false, false, 'serverGrid_fotografia_server_handler_edit');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editor = new ImageUploader('fotografia_server_edit');
            $editor->SetShowImage(false);
            $editColumn = new FileUploadingColumn('Fotografia Server', 'fotografia_server', $editor, $this->dataset, false, false, 'serverGrid_fotografia_server_handler_insert');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            $grid->SetShowAddButton(true && $this->GetSecurityInfo()->HasAddGrant());
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_cliente_nombre_cliente_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_proyecto_descripcion_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_sitio_handler_print');
            $grid->AddPrintColumn($column);
            
            //
            // View column for fotografia_server field
            //
            $column = new BlobImageViewColumn('fotografia_server', 'fotografia_server', 'Fotografia Server', $this->dataset, true, 'serverGrid_fotografia_server_handler_print');
            $grid->AddPrintColumn($column);
        }
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_cliente_nombre_cliente_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_proyecto_descripcion_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_sitio_handler_export');
            $grid->AddExportColumn($column);
            
            //
            // View column for fotografia_server field
            //
            $column = new BlobImageViewColumn('fotografia_server', 'fotografia_server', 'Fotografia Server', $this->dataset, true, 'serverGrid_fotografia_server_handler_export');
            $grid->AddExportColumn($column);
        }
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_cliente_nombre_cliente_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_id_proyecto_descripcion_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('serverGrid_sitio_handler_compare');
            $grid->AddCompareColumn($column);
            
            //
            // View column for fotografia_server field
            //
            $column = new BlobImageViewColumn('fotografia_server', 'fotografia_server', 'Fotografia Server', $this->dataset, true, 'serverGrid_fotografia_server_handler_compare');
            $grid->AddCompareColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new server_equiposPage('server_equipos', $this, array('id_server'), array('id_server'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserGrantForDataSource('server.equipos'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('server.equipos'));
            $detailPage->SetTitle('Equipos');
            $detailPage->SetMenuLabel('Equipos');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('server_equipos_handler');
            $handler = new PageHTTPHandler('server_equipos_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_cliente_nombre_cliente_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_proyecto_descripcion_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_sitio_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_list', new ImageFitByHeightResizeFilter(60));
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_cliente_nombre_cliente_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_proyecto_descripcion_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_sitio_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_print', new ImageFitByHeightResizeFilter(60));
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_cliente_nombre_cliente_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_proyecto_descripcion_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_sitio_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_compare', new ImageFitByHeightResizeFilter(60));
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_cliente_nombre_cliente_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_id_proyecto_descripcion_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'serverGrid_sitio_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_view', new ImageFitByHeightResizeFilter(60));
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'serverGrid_fotografia_server_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new serverPage("server", "server.php", GetCurrentUserGrantForDataSource("server"), 'UTF-8');
        $Page->SetTitle('Server');
        $Page->SetMenuLabel('Server');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("server"));
