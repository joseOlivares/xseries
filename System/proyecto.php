 ...
 */
    ...
    class proyecto_serversPage extends DetailPage
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_proyecto_descripcion_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_sitio_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_proyecto_descripcion_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_sitio_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new FileUploadingColumn('Fotografia Server', 'fotografia_server', $editor, $this->dataset, false, false, 'DetailGridproyecto.servers_fotografia_server_handler_edit');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editor = new ImageUploader('fotografia_server_edit');
            $editor->SetShowImage(false);
            $editColumn = new FileUploadingColumn('Fotografia Server', 'fotografia_server', $editor, $this->dataset, false, false, 'DetailGridproyecto.servers_fotografia_server_handler_insert');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_proyecto_descripcion_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_sitio_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_proyecto_descripcion_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_sitio_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_compare');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_id_proyecto_descripcion_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridproyecto.servers_sitio_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_list', $column);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_proyecto_descripcion_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_sitio_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_proyecto_descripcion_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_sitio_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_proyecto_descripcion_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_sitio_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new DownloadHTTPHandler($this->dataset, 'fotografia_server', 'fotografia_server_handler', '', '', true);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'DetailGridproyecto.servers_fotografia_server_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for nombre_cliente field
            //
            $column = new TextViewColumn('id_cliente', 'id_cliente_nombre_cliente', 'Id Cliente', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_cliente_nombre_cliente_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_proyecto', 'id_proyecto_descripcion', 'Id Proyecto', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_id_proyecto_descripcion_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('sitio', 'sitio', 'Sitio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridproyecto.servers_sitio_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new DownloadHTTPHandler($this->dataset, 'fotografia_server', 'fotografia_server_handler', '', '', true);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $handler = new ImageHTTPHandler($this->dataset, 'fotografia_server', 'DetailGridproyecto.servers_fotografia_server_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class proyectoPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserGrantForDataSource('proyecto.servers')->HasViewGrant() && $withDetails)
            {
            //
            // View column for proyecto_servers detail
            //
            $column = new DetailColumn(array('id_proyecto'), 'proyecto.servers', 'proyecto_servers_handler', $this->dataset, 'Servers');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new proyecto_serversPage('proyecto_servers', $this, array('id_proyecto'), array('id_proyecto'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserGrantForDataSource('proyecto.servers'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('proyecto.servers'));
            $detailPage->SetTitle('Servers');
            $detailPage->SetMenuLabel('Servers');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('proyecto_servers_handler');
            $handler = new PageHTTPHandler('proyecto_servers_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
