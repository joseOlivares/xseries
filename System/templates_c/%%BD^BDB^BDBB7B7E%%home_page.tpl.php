...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'home_page.tpl', 28, false),)), $this); ?>
<?php ob_start(); ?>
...
?>
        <?php if (is_null ( $this->_tpl_vars['SelectedGroup'] ) || $this->_tpl_vars['Group'] == $this->_tpl_vars['SelectedGroup']): ?>
            <div class="row pgui-home-row<?php if ($this->_tpl_vars['Group'] == 'Default'): ?> pgui-home-group-default<?php endif; ?>">
            <?php if ($this->_tpl_vars['Group'] != 'Default'): ?>
                <h2 class="col-md-12 col-sm-12 col-xs-12 pgui-home-group"><?php echo $this->_tpl_vars['Group']; ?>
</h2>
            <?php endif; ?>
