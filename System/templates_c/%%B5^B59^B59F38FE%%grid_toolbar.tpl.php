...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'list/grid_toolbar.tpl', 8, false),array('modifier', 'sprintf', 'list/grid_toolbar.tpl', 32, false),array('modifier', 'escape', 'list/grid_toolbar.tpl', 174, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['Captions']->GetMessageString('CompareSelected'); ?>
                            ...
                            <?php if ($this->_tpl_vars['DataGrid']['AllowCompare'] && $this->_tpl_vars['DataGrid']['AllowDeleteSelected']): ?>
                                <li class="divider"></li>
                            <?php endif; ?>

                            <?php if ($this->_tpl_vars['DataGrid']['AllowDeleteSelected']): ?>
                                <li>
                                    <a href="#" class="js-action" data-type="delete" data-url="<?php echo $this->_tpl_vars['Page']->getLink(); ?>
">
