...
unset($_smarty_tpl_vars);
 ?>>
        ...
        <?php if ($this->_tpl_vars['Editor']->hasEmptyChoice()): ?>
            <option value=""><?php echo $this->_tpl_vars['Editor']->getEmptyDisplayValue(); ?>
</option>
        <?php endif; ?>
...
"<?php if ($this->_tpl_vars['Editor']->getValue() == $this->_tpl_vars['value']): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['displayValue']; ?>
    ...
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'editors/nested_insert_button.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</div>