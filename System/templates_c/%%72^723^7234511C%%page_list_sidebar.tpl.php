...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'page_list_sidebar.tpl', 44, false),)), $this); ?>
...
?>
                        <?php if ($this->_tpl_vars['PageListPage']['GroupName'] == $this->_tpl_vars['Group'] && $this->_tpl_vars['PageListPage']['IsCurrent']): ?>
